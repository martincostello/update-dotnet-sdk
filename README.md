...
| `draft`                 | If true, any pull request created by the action is opened as a draft.                               | `false`                                                 |
...
| `user-email`            | The optional email address to use for the Git commit.                                               | `41898282+github-actions[bot]@users.noreply.github.com` |
